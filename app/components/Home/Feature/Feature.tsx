...
const Feature = () => {
  const features = [
    ...
    {
      icon: <FaComputer className="text-purple-500" />,
        ...
        <div className="grid mt-16 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div
              ...
              key={index}
              className="flex items-center space-x-3 justify-center p-4 bg-white rounded-lg shadow-md"
            >
              <div className="w-14 h-14 bg-gray-200 text-[25px] bg-opacity-10 flex items-center justify-center flex-col rounded-full">
